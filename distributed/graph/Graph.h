...
public:
    ...
    Graph(size_t v, const std::vector<std::vector<bool>> &adj);

    Graph(size_t v, const std::vector<std::vector<int>> &adj);
    ...
    std::pair<const std::vector<int>, const int> welshPowellColoring(const std::function<void(std::vector<int> &,
    ...
    std::pair<const std::vector<int>, const int> optimizedPowellColoring(const std::function<void(std::vector<int> &,
                                                                                                  const std::function<bool(
                                                                                                          const int &,
                                                                                                          const int &)> &)> &sort = [](
            std::vector<int> &vertices, const std::function<bool(const int &, const int &)> &comparator) -> void {
